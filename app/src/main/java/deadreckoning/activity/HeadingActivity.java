...
import deadreckoning.bias.GyroscopeBias;
...
public class HeadingActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDirectionCosine = findViewById(R.id.textDirectionCosine);
        textGyroU = findViewById(R.id.textGyroscopeU);
        textGyroC = findViewById(R.id.textGyroscope);
        textMagneticField = findViewById(R.id.textMagneticField);
        textComplimentaryFilter = findViewById(R.id.textRotationVector);
