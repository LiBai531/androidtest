...
public class MapMatchingMain {
    ...
    private void start(CmdArgs args) {
        String action = args.get("action", "match").toLowerCase();
        ...
        if (action.equals("import")) {
            ...
            args.put("datareader.file", args.get("datasource", "C:\\Users\\83443\\Desktop\\here.osm"));

            // standard should be to remove disconnected islands            
            if (!args.has("prepare.min_one_way_network_size")) {
                args.put("prepare.min_one_way_network_size", 20);
            }
            ...
            String gpxLocation = args.get("gpx", "C:\\Users\\83443\\Desktop\\show\\Explorer_1523112480068.gpx");
            ...
            for (File gpxFile : files) {
                try {
                    ...
                    String outFile = gpxFile.getAbsolutePath() + ".new.gpx";
