...
import deadreckoning.dialog.AccessUserDialogFragment;
import deadreckoning.dialog.SensorCalibrationDialogFragment;
import deadreckoning.dialog.UserDetailsDialogFragment;
...
public class UserListActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO:user_list  stride_list  preferred_step_counter
        SharedPreferences sharedPreference = getSharedPreferences(ExtraFunctions.PREFS_NAME, 0);// 0:only this app
